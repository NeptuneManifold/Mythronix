...
public class PurifierContainer extends Container {
    ...
    public PurifierContainer(int windowId, World world, BlockPos pos, PlayerInventory inv, PlayerEntity player) {
        super(ModContainers.PURIFIER_CONTAINER.get(), windowId);
        ...
        if(tileEntity != null){
            tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(h -> {
                addSlot(new SlotItemHandler(h,0,8,36));
                addSlot(new SlotItemHandler(h,1,80,8));
                addSlot(new SlotItemHandler(h,2,80,63));
                addSlot(new SlotItemHandler(h,3,152,36));
            });
        }
    }
