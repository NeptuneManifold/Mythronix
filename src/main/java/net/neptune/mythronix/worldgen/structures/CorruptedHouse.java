...
public class CorruptedHouse extends Structure<NoFeatureConfig> {

    public CorruptedHouse() {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return CorruptedHouse.Start::new;
    }
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn,
            ...
            JigsawManager.addPieces(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.registry(Registry.TEMPLATE_POOL_REGISTRY)
                            .get().get(new ResourceLocation(Main.MODID, "corrupter_house/start_pool")),
